        ...
        link: function(scope, element, attrs) {
          ...
          on_treeData_change = function() {
            ...
            add_branch_to_list = function(level, branch, visible) {
              ...
              // 如果this.row没有下级且hasChild字段等于0，tree_icon = attrs.iconLeaf;
              // 否则选择iconCollapse或者iconCollapse
              if (!branch.noLeaf && (!branch.children || branch.children.length === 0) && (branch.hasChild === 0||branch.hasChild === undefined)){
                tree_icon = attrs.iconLeaf;
                if (__indexOf.call(branch.classes, "leaf") < 0) {
                  branch.classes.push("leaf");
                }
              } else {
                if (branch.expanded||branch.hasChild === 0) {
                  tree_icon = attrs.iconCollapse;
                } else if(!branch.expanded||branch.hasChild === 1){
